 ...
 * @since 2017-05-15
 */
public class BasexTypeUtils {

    private static final Logger LOGGER = LoggerFactory.getLogger(BasexTypeUtils.class);
    ...
    private BasexTypeUtils() {}

    public static boolean isSimpleType(Class<?> type) {
        return type.isPrimitive() || type.equals(String.class); // || isBoxingType(type); // TODO: Verify boxing types
    }
